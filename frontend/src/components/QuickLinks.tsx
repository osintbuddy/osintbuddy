...
export function QuickLink({ title, description, href, icon }: any) {
  return (
    <NavLink to={href} className="group relative rounded-xl border border-mirage-700 from-black/25 to-black/10  hover:from-black/50 hover:to-black/35 bg-gradient-to-tr hover:border-primary-350 transition-all duration-100 ease-in-out">
