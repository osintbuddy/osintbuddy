    ...
    >
      <defs>
        ...
        <linearGradient id="flowingConnection" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <animateTransform attributeName="gradientTransform" type="translate" values="0,0; 90,0; 100,0" dur="14s" repeatCount="indefinite" />
        </linearGradient>
      ...
      <g>
        ...
        <circle r="2" fill="#64748b" fillOpacity="0.3">
          <animateMotion dur="12s" repeatCount="indefinite" path="M600 50 Q 580 200, 620 350 Q 640 500, 600 650 Q 560 800, 620 950" />
        </circle>

        <circle r="2" fill="#64748b" fillOpacity="0.3">
          <animateMotion dur="15s" repeatCount="indefinite" path="M1000 0 Q 1020 150, 980 300 Q 960 450, 1000 600 Q 1040 750, 980 900 Q 960 1050, 1000 1080" />
        </circle>
