        ...
        <div class="flex flex-1 flex-col overflow-y-auto">
          <nav class="flex-1 flex flex-col mt-px">
            ...
            <div class="mt-auto">
              ...
              >
                <Icon icon='settings'
                  class={`mr-2 shrink-0 h-6 w-6 duration-200 transition-all text-slate-600/50 ${location.pathname.includes("settings") && '!mr-2 hover:-ml-0.5 !text-primary'} ${showSidebar ? 'translate-x-0' : 'translate-x-[12.75rem]'}`}
                />
