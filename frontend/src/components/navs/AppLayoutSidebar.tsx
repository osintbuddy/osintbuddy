...
export default function AppLayoutSidebar({ showSidebar, toggleSidebar }: AppLayoutSidebarProps) {
  ...
  return (
    <div class={`fixed inset-y-0 flex border-r from-cod-800/50 to-cod-800/40 bg-gradient-to-br shadow-xl border-mirage-700/20 w-64 flex-col transition-transform duration-100 ${showSidebar ? "translate-x-0" : "-translate-x-52 border-r-2"}`}>
