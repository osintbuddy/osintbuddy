...
import { useAttachmentsStore } from '@/app/store'

interface Props { entityId: string; entityTitle: string }

export default function EntityToolbar({ entityId, entityTitle }: Props) {
