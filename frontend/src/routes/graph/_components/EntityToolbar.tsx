...
interface Props { entityId: string; entityTitle: string; entityData?: any }

export default function EntityToolbar({ entityId, entityTitle, entityData }: Props) {
    ...
    <NodeToolbar position={Position.Top} class='pointer-events-none'>
      <div className='relative flex gap-x-2 pointer-events-auto'>
        <button
          ...
          onClick={() => properties.openWith(entityId, entityTitle, entityData)}
