...
pub fn config(conf: &mut web::ServiceConfig) {
    let scope = web::scope("/api")
        ...
        .service(cases::create_graph_handler)
        .service(cases::update_graph_handler)
        .service(cases::delete_graph_handler)
        .service(cases::list_graph_handler)
        .service(cases::get_case_handler)
        .service(cases::favorite_graph_handler)
